...
import { Menu, BedDouble, UtensilsCrossed, BarChart3, Download, LogOut, Calendar, PanelLeftClose, PanelLeftOpen } from "lucide-react"
...
export function AdminHeader({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <div className="flex h-14 items-center justify-between gap-2 border-b bg-white px-4 dark:border-zinc-800 dark:bg-zinc-950 lg:px-6">
      <button
        onClick={onMenuClick}
        className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-sm font-medium text-zinc-600 hover:bg-zinc-100 md:hidden dark:text-zinc-400 dark:hover:bg-zinc-800"
